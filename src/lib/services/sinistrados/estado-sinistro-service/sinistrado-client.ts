...
export class SinistradoClient extends BaseApiClient {
    ...
    public async getById(id: string): Promise<ResponseApi<GSResponse<SinistradoDTO>>> {
    ...
    public async moveToHistory(id: string): Promise<ResponseApi<GSResponse<string>>> {
        return this.httpClient.postRequest(
            state.URL,
            `${BASE}/${id}/move-to-history`,
            {}
        )
    }

    public async restoreFromHistory(id: string): Promise<ResponseApi<GSResponse<string>>> {
        return this.httpClient.postRequest(
            state.URL,
