...
import { columns, getColumnsWithViewCallback } from './listagem-atestados-table.columns'
import { ListagemAtestadosFilterControls } from './listagem-atestados-filter-controls'
...
export function ListagemAtestadosTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  return (
    <DataTable
      ...
      FilterControls={ListagemAtestadosFilterControls}
      initialPage={page}
