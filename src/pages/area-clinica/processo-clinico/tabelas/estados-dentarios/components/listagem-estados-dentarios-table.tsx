...
import { getColumnsWithViewCallback } from './listagem-estados-dentarios-table.columns'
...
export function ListagemEstadosDentariosTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const tableColumns = onOpenView
    ...
    : getColumnsWithViewCallback(() => {}, undefined, undefined)
