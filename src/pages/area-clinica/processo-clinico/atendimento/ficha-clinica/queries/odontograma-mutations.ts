...
} from '@/lib/services/processo-clinico/odontologia/estados-dentarios-service'
import type {
  CreateTiposTratamentoDentarioRequest,
  UpdateTiposTratamentoDentarioRequest,
} from '@/lib/services/processo-clinico/odontologia/tipos-tratamento-dentario-service'
import type {
  EstadosDentariosDTO,
...
const ODONTOGRAMA_QUERY_KEY = ['odontologia', 'odontograma-definitivo']
