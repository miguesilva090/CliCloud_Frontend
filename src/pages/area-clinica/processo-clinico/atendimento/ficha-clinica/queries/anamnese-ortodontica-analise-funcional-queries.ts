...
export { useCreateAnamneseOrtodonticaAnaliseFuncional, useUpdateAnamneseOrtodonticaAnaliseFuncional } from './anamnese-ortodontica-analise-funcional-mutations'
