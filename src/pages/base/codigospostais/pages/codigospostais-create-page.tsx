...
export function CodigosPostaisCreatePage() {
  ...
  return (
    <PageContainer>
      <PageHead title='Criar Código Postal | Luma' />
      ...
      <div className='flex items-center gap-4'>
        ...
        <Breadcrumbs
          items={[
            ...
            {
              title: 'Criar',
              link: `/utilitarios/tabelas/geograficas/codigospostais/create?instanceId=${instanceId}`,
            },
          ]}
        />
      </div>
      ...
      <div className='rounded-lg border bg-card'>
        <div className='border-b px-6 py-4'>
          <h2 className='text-base font-medium'>Criar Código Postal</h2>
        </div>
        <div className='p-6'>
          <CodigoPostalCreateForm modalClose={handleClose} />
        </div>
      </div>
    </PageContainer>
  )
