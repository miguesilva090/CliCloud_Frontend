...
export function DistritosCreatePage() {
  ...
  return (
    <PageContainer>
      <PageHead title='Criar Distrito | Luma' />
      ...
      <div className='flex items-center gap-4'>
        ...
        <Breadcrumbs
          items={[
            ...
            {
              title: 'Criar',
              link: `/utilitarios/tabelas/geograficas/distritos/create?instanceId=${instanceId}`,
            },
          ]}
        />
      </div>
      ...
      <div className='rounded-lg border bg-card'>
        <div className='border-b px-6 py-4'>
          <h2 className='text-base font-medium'>Criar Distrito</h2>
        </div>
        <div className='p-6'>
          <DistritoCreateForm modalClose={handleClose} />
        </div>
      </div>
    </PageContainer>
  )
