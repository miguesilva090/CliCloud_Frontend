...
export function FreguesiasUpdatePage() {
  ...
  const freguesiaId = searchParams.get('freguesiaId')
  const instanceId = searchParams.get('instanceId') || 'default'
  const formId = instanceId

  const { data: freguesiaData, isLoading } = useGetFreguesia(freguesiaId || '')
  ...
  const currentFreguesia = freguesiaData

  return (
    <PageContainer>
      <PageHead title='Atualizar Freguesia | Luma' />
      ...
      <div className='flex items-center gap-4'>
        ...
        <Breadcrumbs
          items={[
            ...
            {
              title: 'Atualizar',
              link: `/utilitarios/tabelas/geograficas/freguesias/update?freguesiaId=${freguesiaId}&instanceId=${instanceId}`,
            },
          ]}
        />
      </div>
      ...
      <div className='rounded-lg border bg-card'>
        <div className='border-b px-6 py-4'>
          <h2 className='text-base font-medium'>Atualizar Freguesia</h2>
        </div>
        <div className='p-6'>
          {isLoading ? (
            ...
            <FreguesiaUpdateForm
              ...
              initialData={{
                nome: currentFreguesia.nome || '',
                concelhoId: currentFreguesia.concelhoId || '',
              }}
            />
          ) : (
