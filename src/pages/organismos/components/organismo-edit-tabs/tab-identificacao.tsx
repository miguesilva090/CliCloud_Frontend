...
export function TabIdentificacao({
  ...
  const codigoDisplay = organismo?.id
    ? String(organismo.id).substring(0, 8)
    : '—'
      ...
      <section className='space-y-2'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-y-2'>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Código Clínica</FormLabel>
                <FormControl>
                  <Input
                    className='h-7'
                    placeholder='Código clínica'
                    readOnly={readOnly}
                    {...field}
                    value={field.value ?? ''}
                  />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Obs. Faturação</FormLabel>
                <FormControl>
                  <Input
                    className='h-7'
                    placeholder='Obs. Faturação...'
                    readOnly={readOnly}
                    {...field}
                    value={field.value ?? ''}
                  />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Contacto (nome)</FormLabel>
                <FormControl>
                  <Input
                    className='h-7'
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex flex-row items-center gap-2 space-y-0 w-fit max-w-full'>
                ...
                <FormLabel className='!mb-0 font-normal cursor-pointer'>Nacional</FormLabel>
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex flex-row items-center gap-2 space-y-0 w-fit max-w-full'>
                ...
                <FormLabel className='!mb-0 font-normal cursor-pointer'>GlobalBooking</FormLabel>
              </FormItem>
            )}
          />
          {localidadeDisplay && (
