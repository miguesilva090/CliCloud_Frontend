...
export function ListaEsperaTratamentoObservacoesModal({
  open,
  onOpenChange,
  listaEsperaId,
  utenteLabel,
  ...
  useEffect(() => {
    ...
    void ListaEsperaTratamentoAdministrativoService(listPermId)
  ...
  const handleGuardar = async () => {
    ...
    setSaving(true)
    try {
      const res = await ListaEsperaTratamentoAdministrativoService(listPermId).appendObservacao(
        listaEsperaId,
