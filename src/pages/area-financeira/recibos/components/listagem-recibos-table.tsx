...
import {
  getRecibosColumnsWithViewCallback,
  recibosColumns,
} from './listagem-recibos-table.columns'
...
export function ListagemRecibosTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const tableColumns = onOpenView
    ? getRecibosColumnsWithViewCallback(onOpenView, { canView: true })
    : recibosColumns
