...
} from './listagem-modos-pagamento-table.columns'
...
export function ListagemModosPagamentoTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const FilterControlsWrapper = (props: { table: any }) => (
    <FilterControls
      ...
      onMostrarHistoricoChange={onMostrarHistoricoChange}
    />
  )
