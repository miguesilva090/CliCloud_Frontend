...
export const columns: DataTableColumnDef<LocalTratamentoTableDTO>[] = [
  {
...
): DataTableColumnDef<LocalTratamentoTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<LocalTratamentoTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
