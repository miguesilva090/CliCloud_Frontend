...
export const columns: DataTableColumnDef<RegiaoCorpoTableDTO>[] = [
    {
...
): DataTableColumnDef<RegiaoCorpoTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<RegiaoCorpoTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
