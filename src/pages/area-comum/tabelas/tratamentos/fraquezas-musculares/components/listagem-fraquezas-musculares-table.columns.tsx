...
export const columns: DataTableColumnDef<FraquezasMuscularesTableDTO>[] = [
    {
...
): DataTableColumnDef<FraquezasMuscularesTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<FraquezasMuscularesTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
