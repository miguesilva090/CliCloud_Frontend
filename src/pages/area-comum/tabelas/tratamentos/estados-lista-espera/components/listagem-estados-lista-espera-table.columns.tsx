...
export const columns: DataTableColumnDef<EstadoListaEsperaTableDTO>[] = [
  {
...
): DataTableColumnDef<EstadoListaEsperaTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<EstadoListaEsperaTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
