...
export const columns: DataTableColumnDef<TipoDeDorTableDTO>[] = [
  {
...
export function getColumnsWithViewCallback(
  onOpenView: (data: TipoDeDorTableDTO) => void,
  onOpenEdit?: (data: TipoDeDorTableDTO) => void,
  onOpenDelete?: (data: TipoDeDorTableDTO) => void,
  rowActionPermissions?: AreaComumListRowActionPermissions,
): DataTableColumnDef<TipoDeDorTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<TipoDeDorTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
