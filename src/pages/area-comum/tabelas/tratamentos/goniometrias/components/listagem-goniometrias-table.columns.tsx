...
export const columns: DataTableColumnDef<GoniometriasTableDTO>[] = [
    {
...
): DataTableColumnDef<GoniometriasTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<GoniometriasTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
