...
export const columns: DataTableColumnDef<MarcaAparelhoTableDTO>[] = [
  {
...
): DataTableColumnDef<MarcaAparelhoTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<MarcaAparelhoTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
