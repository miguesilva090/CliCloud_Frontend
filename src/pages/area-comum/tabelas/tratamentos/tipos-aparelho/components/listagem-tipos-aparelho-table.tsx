...
import { columns, getColumnsWithViewCallback } from './listagem-tipos-aparelho-table.columns'
...
export function ListagemTiposAparelhoTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const tableColumns =
    onOpenView ? getColumnsWithViewCallback(onOpenView, onOpenEdit, onOpenDelete) : columns
  return (
    <DataTable
