...
import { columns, getColumnsWithViewCallback } from './listagem-modelos-aparelho-table.columns'

type FilterControlsComponent = React.ComponentType<{ table: any; columns: any[]; onApplyFilters: () => void; onClearFilters: () => void }>

export function ListagemModelosAparelhoTable({
  data,
  isLoading,
  pageCount,
  totalRows,
