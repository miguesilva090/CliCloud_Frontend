...
export const columns: DataTableColumnDef<ViaAdministracaoTableDTO>[] = [
  {
    accessorKey: 'descricao',
    header: 'Via de Administração',
    sortKey: 'descricao',
    enableSorting: true,
    enableHiding: true,
...
): DataTableColumnDef<ViaAdministracaoTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<ViaAdministracaoTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
