...
import { ListagemMedicosFilterControls } from './listagem-medicos-filter-controls'

export function ListagemMedicosTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  return (
    <DataTable<MedicoTableDTO, any>
      ...
      FilterControls={ListagemMedicosFilterControls}
      initialPage={page}
