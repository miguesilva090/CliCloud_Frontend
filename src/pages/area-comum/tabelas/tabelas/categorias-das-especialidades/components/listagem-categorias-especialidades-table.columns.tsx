...
export const columns: DataTableColumnDef<CategoriaEspecialidadeTableDTO>[] = [
  {
...
): DataTableColumnDef<CategoriaEspecialidadeTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<CategoriaEspecialidadeTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
