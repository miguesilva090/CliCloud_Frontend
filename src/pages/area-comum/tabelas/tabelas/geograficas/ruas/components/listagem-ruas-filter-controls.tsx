...
/** Painel de pesquisa da listagem de Ruas: só Nome (De/Até) e checkbox Intervalo. A lupa pesquisa apenas por nome. */
export function ListagemRuasFilterControls({
  table,
}: {
  table: any
  columns: any[]
