...
} from './listagem-ruas-table.columns'
import { ListagemRuasFilterControls } from './listagem-ruas-filter-controls'
...
export function ListagemRuasTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const FilterControls = FilterControlsOverride ?? ListagemRuasFilterControls
