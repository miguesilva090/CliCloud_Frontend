...
/** Painel de pesquisa da listagem de Distritos: só Nome (De/Até) e checkbox Intervalo. A lupa pesquisa apenas por nome. Sem Código. */
export function ListagemDistritosFilterControls({
  table,
}: {
  table: any
  columns: any[]
