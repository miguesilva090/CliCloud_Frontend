...
/** Painel de pesquisa da listagem de Países: só Nome (De/Até) e checkbox Intervalo. A lupa pesquisa apenas por nome. Código não é usado na pesquisa. */
export function ListagemPaisesFilterControls({
  table,
}: {
  table: any
  columns: any[]
