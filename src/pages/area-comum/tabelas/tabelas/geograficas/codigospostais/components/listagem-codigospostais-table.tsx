...
} from './listagem-codigospostais-table.columns'
import { ListagemCodigosPostaisFilterControls } from './listagem-codigospostais-filter-controls'
...
export function ListagemCodigospostaisTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const FilterControls =
    FilterControlsOverride ?? ListagemCodigosPostaisFilterControls
