...
/** Painel de pesquisa da listagem de Freguesias: só Nome (De/Até) e checkbox Intervalo. A lupa pesquisa apenas por nome. */
export function ListagemFreguesiasFilterControls({
  table,
}: {
  table: any
  columns: any[]
