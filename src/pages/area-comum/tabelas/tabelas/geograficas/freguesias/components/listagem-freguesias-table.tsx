...
} from './listagem-freguesias-table.columns'
import { ListagemFreguesiasFilterControls } from './listagem-freguesias-filter-controls'
...
export function ListagemFreguesiasTable({
  data,
  isLoading,
  pageCount,
  totalRows,
  ...
  const FilterControls = FilterControlsOverride ?? ListagemFreguesiasFilterControls
