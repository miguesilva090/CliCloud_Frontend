...
import { ListagemEntidadesFinanceirasFilterControls } from '../components/listagem-entidades-financeiras-responsaveis-filter-controls'
import {
...
export function ListagemEntidadesFinanceirasResponsaveisPage() {
  ...
  const {
    ...
    useGetDataPaginated: useGetEntidadesFinanceirasPaginated,
    usePrefetchAdjacentData: usePrefetchAdjacentEntidadesFinanceiras})
      ...
      <DashboardPageContainer>
        ...
        {isError ? (
          <Alert variant='destructive' className='mb-4'>
            <AlertTitle>Falha ao carregar entidades financeiras</AlertTitle>
            <AlertDescription>
              {errorMessage ||
                'Ocorreu um erro ao pedir a lista de entidades financeiras responsáveis.'}
            </AlertDescription>
          </Alert>
        ) : null}

        <ListagemEntidadesFinanceirasTable
          data={entidades}
          isLoading={isLoading}
          pageCount={pageCount}
          totalRows={totalRows}
