...
export const columns: DataTableColumnDef<ProvenienciaUtenteTableDTO>[] = [
  {
...
export function getColumnsWithViewCallback(
  onOpenView: (data: ProvenienciaUtenteTableDTO) => void,
  onOpenEdit?: (data: ProvenienciaUtenteTableDTO) => void,
  onOpenDelete?: (data: ProvenienciaUtenteTableDTO) => void,
  rowActionPermissions?: AreaComumListRowActionPermissions,
): DataTableColumnDef<ProvenienciaUtenteTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<ProvenienciaUtenteTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
