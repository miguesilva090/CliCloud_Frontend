...
export const columns: DataTableColumnDef<GrupoSanguineoTableDTO>[] = [
  {
...
): DataTableColumnDef<GrupoSanguineoTableDTO>[] {
  return [
    ...columns.filter((c) => c.id !== 'actions'),
    createAreaComumListActionsColumnDef<GrupoSanguineoTableDTO>({
      onOpenView,
      onOpenEdit,
      onOpenDelete,
